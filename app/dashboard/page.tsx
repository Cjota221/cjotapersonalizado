    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="w-64 bg-white border-r border-gray-200">
        ...
        <nav className="px-4 space-y-2">
          ...
          <Link href={`/${store?.slug || ''}`} target="_blank" className="block px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg">🏪 Ver Loja</Link>
        </nav>
      </aside>
      <main className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <p className="text-sm font-medium text-gray-600">Loja</p>
            <p className="text-lg font-semibold text-blue-600 mt-2">{store?.store_name || 'N/A'}</p>
          </div>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
          <h3 className="font-semibold text-blue-900 mb-2">ℹ️ Versão de Teste</h3>
