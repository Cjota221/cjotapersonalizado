  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {/* Products Grid */}
        <section className="container mx-auto px-4 py-8" id="produtos">
        ...
        <footer className="bg-gray-900 text-white mt-12">
          <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-base font-bold mb-3">{store.store_name}</h3>
              ...
              <div>
                ...
                <Link href={`/${slug}`} className="block text-gray-400 hover:text-white transition-colors mb-2 text-sm">
                  Produtos
                </Link>
                <Link href={`/${slug}/carrinho`} className="block text-gray-400 hover:text-white transition-colors text-sm">
                  Meu Carrinho
                </Link>
              </div>
            </div>
